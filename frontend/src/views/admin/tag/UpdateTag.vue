<template>
  <div class="card overflow-visible flex-shrink-0 max-w-lg shadow-2xl bg-base-100 mx-auto" v-if="currentTag">
    ...
    <div class="card-body">
      <ValidationForm @submit="updateTag" :validation-schema="schema">
        <div class="form-control">
          ...
          <Field id="name" name="name" type="text" class="input input-bordered" v-model="currentTag.name" />
