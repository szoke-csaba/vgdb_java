<template>
  <div class="card flex-shrink-0 max-w-lg shadow-2xl bg-base-100 mx-auto">
    <div class="p-8 pb-0 flex items-center">
      ...
      <h1 class="text-4xl pl-5">Add publisher</h1>
    </div>
    <div class="card-body">
      <ValidationForm @submit="savePublisher" :validation-schema="schema">
...
<script>
  ...
  export default {
    ...
    mounted() {
      useHead({
        title: computed(() => 'Admin - Add publisher | ' + process.env.VUE_APP_TITLE),
      })
    }
  }
</script>
